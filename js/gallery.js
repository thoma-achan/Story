...
galleryData.forEach(item => {
    const galleryItem = `
        <div class="col-md-6 col-lg-4 col-xl-3 wow fadeInUp" data-wow-delay="0.8s">
            <div class="gallery-item" style="padding-top:60px">
                <div class="gallery-img">
                    <img class="img-fluid w-100" src="${item.imgSrc}" alt="">
                    <div class="hover-style"></div>
                    <div class="search-icon">
                        <a href="${item.imgSrc}" data-lightbox="Gallery-4" class="my-auto">
                ...
                <div class="gallery-overlay bg-light border-secondary border-top-0 p-4" style="border-style: double;">
                    ...
                    <p class="text-dark mb-0">${item.date}</p>
                </div>
            </div>
        </div>
    `;
